      ...
      <form className="flex items-center" onSubmit={onSearch} >
        ...
        <div className="relative w-full">
          ...
          <input
            type="text"
            id="search"
            className="transition-all bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            placeholder="회사명 검색"
            value={term}
            onChange={setSearch}
