...
import SideBarList from "components/Board/Chat/ChatContents/SideBarList";
...
const index = () => {
  return (
    <div className="flex">
      <SideBarList />
      <div className="w-full min-h-[calc(100vh-140px)] flex-grow flex-col items-center justify-center gap-3 flex text-gray-500">
