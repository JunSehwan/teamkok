...
const Fourth = ({ goNextStage, goNews, goCertStage }) => {
  ...
  }, [dispatch, goNextStage, updateAvatarDone])
            ...
            <div className="w-[162px] h-[162px]">
              <ImageWrapper>
                {imageUploading ?
                  ...
                  :
                  <Image
                    className="absolute object-cover rounded-[12px] mx-auto z-10 w-[162px] h-[162px]"
