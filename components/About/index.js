                  ...
                  <div className="w-full md:w-4/12 px-4">
                    <div className="relative flex flex-col mt-4">
                      <div className="px-4 py-5 flex-auto">
                        ...
                        <h6 className="text-xl mb-1 font-semibold text-violet-600">#야근 #분위기 #경력개발</h6>
                  ...
                  <div className="w-full md:w-4/12 px-4">
                    <div className="relative flex flex-col min-w-0 mt-4">
                      <div className="px-4 py-5 flex-auto">
                        ...
                        <h6 className="text-xl mb-1 font-semibold text-violet-600">Save Money & Time
                        </h6>
                        <p className="mb-4 text-blueGray-500">
                  ...
                  <div className="w-full md:w-4/12 px-4">
                    <div className="relative flex flex-col min-w-0 mt-4">
                      <div className="px-4 py-5 flex-auto">
                        ...
                        <h6 className="text-xl mb-1 font-semibold text-violet-600">Culture-fit 인재 채용
                        </h6>
                        <p className="mb-4 text-blueGray-500">
