...
const usePagination = (collectionName, limitCount, target, setTarget) => {
  ...
  }, [db, collectionName, filterNumber]);
  ...
  const getFirstPageWithAdd = useCallback(async () => {
    ...
    setPostLoading(false);
  }, [addDone, collectionName, db, deleteDone, limitCount]);
  ...
  }, [filterNumber, getFirstPageWithFilter]);
  ...
  }, [noMore, onIntersect, postLoading, setTarget, target]);
