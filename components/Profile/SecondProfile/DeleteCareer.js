...
const DeleteCareer = ({ id }) => {
  ...
  return (
    <>
      <button onClick={onClickRemoveCar} className="flex col-start-2 ml-4 md:col-start-auto md:ml-0 md:justify-end items-center" >
      ...
      {removeCarModalOpen ?
        <div className="z-[100] min-w-screen h-screen animated fadeIn faster fixed left-0 top-0 flex justify-center items-center inset-0 outline-none focus:outline-none bg-no-repeat bg-center bg-cover" id="modal-id">
