    ...
    <>
      ...
      >
        <>
          ...
          >
            <div className="mb-4">
              <label className="block mb-1 text-md font-bold text-gray-700" htmlFor="company_name">
                회사명
              </label>
              <input
                className={nameError ?
            ...
            <div className="mb-4">
              <label className="block mb-1 text-md font-bold text-gray-700" htmlFor="position">
                직위
              </label>
              <input
            ...
            <div className="mb-4">
              <label className="block mb-1 text-md font-bold text-gray-700" htmlFor="section">
                부서명
              </label>
              <input
                className=
            ...
            <div className="mb-4">
              <label className="block mb-1 text-md font-bold text-gray-700" htmlFor="job">
                주요업무
              </label>
              <input
                className=
