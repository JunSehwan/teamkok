        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                <div>
                  <Link
                    href="/signup">
                    <a className="py-3 px-8 rounded-lg font-bold text-white bg-blue-600 hover:bg-blue-700 w-full mb-4 sm:w-auto sm:mb-0"
                    >
                      무료로 시작하기</a>
                  </Link>
                </div>
                {/* <div>
                  <a className="py-3 px-5 rounded-lg font-bold text-white bg-gray-900 hover:bg-gray-800 w-full sm:w-auto sm:ml-4" href="#0">
                    Learn more</a>
                </div> */}
              </div>
            </div>
          ...
          <div>
            <div className="relative flex justify-center mb-8" data-aos="zoom-y-out" data-aos-delay="450">
              ...
              // onClick={(e) => { e.preventDefault(); setVideoModalOpen(true); }} 
              // aria-controls="modal"
              >
