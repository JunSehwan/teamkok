...
const index = () => {
  ...
  return (
    <>
      <Head>
        <title>{user?.username}님의 대시보드📱 - JOBCOC</title>
        ...
        <meta property="og:type" content={`${user?.username}님의 대시보드!, JOBCOC`} />
        <meta property="og:title" content={`${user?.username}님의 대시보드!, JOBCOC`} />
