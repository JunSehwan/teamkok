...
const index = () => {
  ...
  return (
    <>
      <Head>
        <title>{user?.username}님을 콕!찍은 팀은? - JOBCOC</title>
        ...
        <meta property="og:type" content={`${user?.username}님을 콕!찍은 팀은?, JOBCOC`} />
        <meta property="og:title" content={`${user?.username}님을 콕!찍은 팀은?, JOBCOC`} />
