...
const index = () => {
  ...
  return (
    <>
      <Head>
        <title>{user?.username}님이 제안받은 연봉은? - JOBCOC</title>
        ...
        <meta property="og:type" content={`${user?.username}님이 제안받은 연봉은?, JOBCOC`} />
        <meta property="og:title" content={`${user?.username}님이 제안받은 연봉은?, JOBCOC`} />
