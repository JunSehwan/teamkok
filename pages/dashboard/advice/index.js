...
const index = () => {
  ...
  return (
    <>
      <Head>
        <title>{user?.username}님에게 조언해준 내용은? - JOBCOC</title>
        ...
        <meta property="og:type" content={`${user?.username}님에게 조언해준 내용은?, JOBCOC`} />
        <meta property="og:title" content={`${user?.username}님에게 조언해준 내용은?, JOBCOC`} />
