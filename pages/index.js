...
const index = () => {
  ...
  return (
    <>
      <Head>
        <title>🪪 보여주고 들려주는 내 이력서 - 잡콕(JOBCOC)</title>

        <meta name="keywords" content="잡콕, jobcoc, 채용사이트, 채용공고, 현업담당자와 대화, 업무문의, 채용문의, 소통플랫폼" />
        <meta name="description" content="1분 자기소개 영상이나 포트폴리오 이미지로 나의 이력을 어필할 수 있습니다. 또한, 채용담당자가 제안하는 동료들의 실질적인 연봉 수준을 확인할 수 있습니다." />

        <meta name="application-name" content="잡콕(JOBCOC) - 개성있는 프로필로 빠르게 취업하기" />
        <meta name="msapplication-tooltip" content="잡콕(JOBCOC)" />

        <meta property="og:type" content="개성있는 채용, 잡콕(JOBCOC)" />
        <meta property="og:title" content="잡콕(JOBCOC) - 개성있는 프로필로 빠르게 취업하기" />
        ...
        <meta name="twitter:card" content="잡콕(JOBCOC)에서 원하는 팀에 합류하세요!" />
        <meta name="twitter:title" content="잡콕(JOBCOC) - 개성있는 프로필로 빠르게 취업하기" />
