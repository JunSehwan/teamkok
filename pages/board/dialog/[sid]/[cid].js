...
import Servers from "components/Dialog/Servers";
import Channels from "components/Dialog/Channels";
import Chat from "components/Dialog/Chat";
import Title from "components/Chat";
  ...
  return (
    <>
      <Head>
        ...
        {/* <title>{channel.name ? channel.name : "TEAMKOK"}</title> */}
